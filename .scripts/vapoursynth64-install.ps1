...
"::set-env name=VAPOURSYNTH_LIB_DIR::$Env:PYTHON/sdk/lib64" # https://help.github.com/en/actions/reference/workflow-commands-for-github-actions#setting-an-environment-variable